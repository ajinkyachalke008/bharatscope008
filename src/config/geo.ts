...
import { INDIA_DEFENSE_INSTALLATIONS } from './india-defense';
import { INDIAN_SEZS, INDIAN_FDI_CITIES, INDIAN_STATE_CAPITALS } from './india-economic';
...
export const INTEL_HOTSPOTS: Hotspot[] = [
  ...
  },
  {
    ...
    agencies: ['RAW', 'IB', 'Indian Armed Forces', 'ISRO', 'NSA (India)'],
    description:
      'Indian government and defense headquarters. Nuclear-armed regional power. Key Indo-Pacific player.',
    status: 'Monitoring',
    escalationScore: 3,
    escalationTrend: 'stable',
    escalationIndicators: [
      'LAC border standoff with China',
      'Kashmir security operations',
      'Indian Ocean naval expansion',
      'Space and missile program advances',
    ],
    history: {
      ...
      precedentCount: 4,
      precedentDescription:
        'Indo-Pak wars (1947, 1965, 1971), Kargil 1999, Balakot strikes 2019, Galwan clash 2020',
      cyclicalRisk: 'Election cycles, Independence Day (Aug 15), Republic Day (Jan 26)',
    },
    whyItMatters:
      'World\u0027s most populous nation; nuclear-armed; critical Indo-Pacific partner; major tech and space power; LAC tensions with China',
  },

  // — India Sub-Hotspots (Bharat Monitor) —
  {
    id: 'mumbai_finhub',
    name: 'Mumbai',
    subtext: 'Financial/Naval Hub',
    lat: 19.08,
    lon: 72.88,
    ...
    agencies: ['BSE', 'NSE', 'RBI', 'Western Naval Command'],
    description:
      "India's financial capital. BSE & NSE exchanges. RBI HQ. Western Naval Command. Largest GDP contributor.",
    status: 'Monitoring',
    escalationScore: 2,
    escalationTrend: 'stable',
    escalationIndicators: [
    ...
    history: {
      lastMajorEvent: 'COVID lockdown market crash',
      lastMajorEventDate: '2020-03-23',
      precedentCount: 3,
      precedentDescription: '1993 serial bombings, 2008 26/11 terror attacks, 2020 market crash',
      cyclicalRisk: 'Monsoon season (Jun-Sep), Diwali trading season',
    },
    whyItMatters:
      'Financial heartbeat of Asia\'s 3rd largest economy; $3.5T+ combined market cap; Western Naval Command guards Arabian Sea',
  },
  {
    id: 'kashmir_loc',
    name: 'Kashmir / LOC',
    subtext: 'LAC/LOC Tensions',
    lat: 34.08,
    lon: 74.80,
    ...
    agencies: ['Indian Army Northern Command', 'BSF', 'CRPF'],
    description:
      'Disputed territory. LOC with Pakistan. LAC with China in Ladakh. Active military deployments.',
    status: 'Elevated',
    escalationScore: 4,
    escalationTrend: 'stable',
    escalationIndicators: [
      ...
      'LAC troop buildup',
      'Internet shutdowns',
      'Militant infiltration attempts',
      'Siachen glacier status',
    ],
    history: {
      lastMajorEvent: 'Galwan Valley clash',
      lastMajorEventDate: '2020-06-15',
      precedentCount: 5,
      precedentDescription: '1947 war, 1965 war, 1999 Kargil, 2016 Uri/surgical strikes, 2019 Balakot/Pulwama, 2020 Galwan',
      cyclicalRisk: 'Summer infiltration season (Apr-Oct), Winter snowfall isolation',
    },
    whyItMatters:
      'Most militarized zone on Earth; nuclear flashpoint; India-China-Pakistan trilateral tensions; Siachen glacier strategic',
  },
  {
    id: 'northeast_india',
    name: 'NE India',
    subtext: 'Ethnic Tensions',
    lat: 26.10,
    lon: 93.60,
    location: 'Northeast India (Seven Sisters)',
    keywords: [
      'assam',
      'manipur',
      'nagaland',
    ...
    agencies: ['Eastern Command', 'Assam Rifles', 'AFSPA'],
    description:
      'Ethnic conflict zone. Myanmar border insurgency. China LAC in Arunachal. Chicken Neck corridor.',
    status: 'Monitoring',
    escalationScore: 3,
    escalationTrend: 'stable',
    escalationIndicators: [
      ...
      'China incursions in Arunachal',
      'AFSPA status changes',
    ],
    history: {
      lastMajorEvent: 'Manipur ethnic violence',
      lastMajorEventDate: '2023-05-03',
      precedentCount: 4,
      precedentDescription: 'Naga insurgency (1950s-), Assam NRC crisis 2019, Manipur violence 2023',
      cyclicalRisk: 'Pre-monsoon tensions (Apr-Jun), Myanmar dry season ops spillover',
    },
    whyItMatters:
      'Siliguri corridor (Chicken Neck) vulnerability; Myanmar border porosity; China claims on Arunachal Pradesh',
  },
  {
    id: 'andaman_nicobar',
    name: 'Andaman & Nicobar',
    subtext: 'Malacca Watch',
    lat: 11.62,
    lon: 92.73,
    ...
    agencies: ['A&N Tri-Service Command', 'Indian Navy', 'Indian Coast Guard'],
    description:
      "India's only tri-service command. Monitors Malacca Strait approaches. INS Baaz at Campbell Bay.",
    status: 'Monitoring',
    escalationScore: 2,
    escalationTrend: 'stable',
    escalationIndicators: [
      'Chinese submarine sightings',
      'PLA Navy Indian Ocean deployments',
      'Infrastructure buildup',
    ],
    history: {
      lastMajorEvent: 'Tri-service command infrastructure expansion',
      lastMajorEventDate: '2024-01-15',
      precedentCount: 1,
      precedentDescription: 'Command established 2001; INS Baaz commissioned 2012',
      cyclicalRisk: 'Cyclone season (Oct-Dec), Chinese survey vessel transits',
    },
    whyItMatters:
      'Controls approaches to Malacca Strait (25% of global trade); only 90 NM from Strait; India\'s power projection platform',
  },
];
...
function mergeAndDeduplicateBases(): MilitaryBase[] {
  const allBases = [...MILITARY_BASES_EXPANDED, ...INDIA_DEFENSE_INSTALLATIONS];
...
export const ECONOMIC_CENTERS: EconomicCenter[] = [
  ...
  ...INDIAN_SEZS.map((s) => ({
    ...
    lon: s.lon,
    country: 'India',
    description: `SEZ - ${s.city}, ${s.state}. ${s.note}`,
  })),
  ...INDIAN_FDI_CITIES.map((c) => ({
    id: c.id,
    name: c.name,
    type: 'financial-hub' as any,
    lat: c.lat,
    lon: c.lon,
    country: 'India',
    description: `FDI Hub - ${c.state}. Speciality: ${c.speciality}`,
  })),
  ...INDIAN_STATE_CAPITALS.map((c) => ({
    id: c.id,
    name: c.name,
    ...
    lon: c.lon,
    country: 'India',
    description: `${c.type} Capital of ${c.state}`,
  })),
];
