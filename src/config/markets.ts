...
export const MARKET_SYMBOLS: MarketSymbol[] = [
  ...
  { symbol: '^NSEBANK', name: 'NIFTY Bank', display: 'BANKNIFTY' },
  { symbol: 'INR=X', name: 'USD / INR', display: 'USD/INR' },
  { symbol: '^INDIAVIX', name: 'India VIX', display: 'INDIAVIX' },
  { symbol: 'RELIANCE.NS', name: 'Reliance Ind', display: 'RELIANCE' },
  { symbol: 'TCS.NS', name: 'Tata Consultancy', display: 'TCS' },
