...
export const PIPELINES: Pipeline[] = [
  ...
  // ===== INDIA — MAJOR PIPELINES (Bharat Monitor) =====

  {
    ...
    status: 'operating',
    points: [
      [72.63, 21.10],  // Hazira, Gujarat
      [74.50, 22.30],  // Via Bharuch
      [77.53, 24.11],  // Vijaipur, MP
      [80.00, 25.50],  // Via Allahabad
      [83.07, 26.29],  // Jagdishpur, UP
    ],
    capacity: '33.4 mcm/day',
    length: '2,702 km',
    operator: 'GAIL',
    countries: ['India'],
  },
  {
    id: 'india-dvpl',
    name: 'Dahej-Vijaipur Pipeline (DVPL)',
    type: 'gas',
    status: 'operating',
    points: [
      [72.57, 21.71],  // Dahej LNG Terminal
      [73.50, 22.50],  // Via Bharuch
      [75.50, 23.50],  // Via Indore
      [77.53, 24.11],  // Vijaipur, MP
    ],
    capacity: '31 mcm/day',
    length: '700 km',
  ...
  {
    id: 'india-mundra-delhi',
    name: 'Mundra-Delhi Pipeline',
    type: 'oil',
    status: 'operating',
    points: [
      [69.71, 22.74],  // Mundra, Gujarat
      [71.50, 24.00],  // Via Rajasthan
      [73.50, 25.50],  // Via Jodhpur
      [75.79, 26.91],  // Via Jaipur
      [77.21, 28.61],  // Delhi
    ],
    capacity: '400,000 bpd',
    length: '1,100 km',
  ...
  {
    id: 'india-mumbai-indore',
    name: 'Mumbai-Manmad-Indore Pipeline',
    type: 'oil',
    status: 'operating',
    points: [
      [72.88, 19.08],  // Mumbai refinery
      [73.80, 20.15],  // Manmad, Maharashtra
      [75.86, 22.72],  // Indore, MP
    ],
    capacity: '200,000 bpd',
    length: '650 km',
    operator: 'IOCL',
  ...
  {
    id: 'india-east-west-kg',
    name: 'East-West Pipeline (KG Basin)',
    type: 'gas',
    status: 'operating',
    points: [
      [82.25, 16.99],  // Kakinada, AP (KG Basin)
      [80.27, 17.39],  // Hyderabad
      [77.41, 23.26],  // Bhopal
      [75.86, 22.72],  // Indore
      [73.00, 21.71],  // Bharuch, Gujarat
    ],
    capacity: '80 mcm/day',
    length: '1,440 km',
    operator: 'RGTIL',
