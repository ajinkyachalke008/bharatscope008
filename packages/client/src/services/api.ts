...
// ─── Demo / fallback data ────────────────────────────────────
const DEMO_EVENTS = [
  { id: 'e1', title: 'Earthquake detected near Indonesia', category: 'natural_disaster', severity: 'high', status: 'active', location: { name: 'Jakarta, Indonesia', lat: -6.2, lng: 106.8 }, timestamp: new Date(Date.now() - 3600000).toISOString(), source: 'USGS', summary: 'A 6.1 magnitude earthquake was detected off the coast of Indonesia.' },
  { id: 'e2', title: 'Cyber attack on European bank', category: 'cyber', severity: 'critical', status: 'active', location: { name: 'Frankfurt, Germany', lat: 50.1, lng: 8.7 }, timestamp: new Date(Date.now() - 7200000).toISOString(), source: 'CISA', summary: 'A sophisticated ransomware attack targeting financial infrastructure.' },
  { id: 'e3', title: 'Political unrest in capital', category: 'political', severity: 'medium', status: 'monitoring', location: { name: 'Brasilia, Brazil', lat: -15.8, lng: -47.9 }, timestamp: new Date(Date.now() - 10800000).toISOString(), source: 'Reuters', summary: 'Large-scale protests reported in the capital city.' },
  { id: 'e4', title: 'Market volatility spike', category: 'economic', severity: 'high', status: 'active', location: { name: 'New York, USA', lat: 40.7, lng: -74.0 }, timestamp: new Date(Date.now() - 5400000).toISOString(), source: 'Bloomberg', summary: 'Major indices showing unusual volatility patterns.' },
  { id: 'e5', title: 'Public health advisory', category: 'health', severity: 'medium', status: 'active', location: { name: 'Geneva, Switzerland', lat: 46.2, lng: 6.1 }, timestamp: new Date(Date.now() - 14400000).toISOString(), source: 'WHO', summary: 'New infectious disease outbreak reported in Southeast Asia.' },
  { id: 'e6', title: 'Environmental spill detected', category: 'environmental', severity: 'high', status: 'active', location: { name: 'Houston, USA', lat: 29.8, lng: -95.4 }, timestamp: new Date(Date.now() - 1800000).toISOString(), source: 'EPA', summary: 'Chemical spill detected near industrial area.' },
  { id: 'e7', title: 'Armed conflict escalation', category: 'conflict', severity: 'critical', status: 'active', location: { name: 'Kyiv, Ukraine', lat: 50.4, lng: 30.5 }, timestamp: new Date(Date.now() - 900000).toISOString(), source: 'OSINT', summary: 'Increased military activity detected near the border region.' },
  { id: 'e8', title: 'Tech infrastructure outage', category: 'technology', severity: 'medium', status: 'resolved', location: { name: 'San Francisco, USA', lat: 37.8, lng: -122.4 }, timestamp: new Date(Date.now() - 21600000).toISOString(), source: 'Downdetector', summary: 'Major cloud provider experiencing service disruptions.' },
];
